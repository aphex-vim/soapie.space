...
date: 2023-09-28
tags: art photography programming
---
## background
...
Most of the gifs I was able to make by combining the frames on [ezgif](https://ezgif.com/). For the last gif, I used [ffmpeg](https://ffmpeg.org/) as the frames exceeded ezgif's upload size limits.
...
Sometime in the future I think it could be fun to try and implement some of these effects on my own. Initially I was going to include some javascript on this page to demonstrate some of the pixel sorting effects, but it ended up being outside the scope of this project.
